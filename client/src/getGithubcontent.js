    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    response_1 = _b.sent();
                    content = Buffer.from(response_1.data.content, 'base64').toString('utf-8');
                    return [2 /*return*/, content];
                case 4: return [2 /*return*/, 'false'];
                case 5: return [3 /*break*/, 7];
                case 6:
                    error_1 = _b.sent();
                    console.error('Error fetching repository contents:', ((_a = error_1.response) === null || _a === void 0 ? void 0 : _a.data) || error_1.message);
                    return [2 /*return*/];
